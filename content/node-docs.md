...
`os.EOL` gives the line delimiter sequence. It's  on Linux and macOS, and `\r` on Windows.
...
You can read them all on [https://nodejs.org/api/os.html#os\_signal\_constants](https://nodejs.org/api/os.html#os\_signal\_constants).
...
You can read more on exit codes at [https://nodejs.org/api/process.html#process\_exit\_codes](https://nodejs.org/api/process.html#process\_exit\_codes)
